...
class CekStatusSuara extends Component
{
    ...
    public function render()
    {
        ...
        if ($this->kecamatan_id) {
            $pemilu = Election::whereRelation('tps.dapil.project', 'id', '=', $project_id)
                ->whereRelation('tps.desa.kecamatan', 'id', '=', $this->kecamatan_id)
                ->orderBy('vote', 'DESC')
                ->get();
        ...
        return view('livewire.cek-status-suara', compact([
            'kabupaten',
            'kecamatan',
            'pemilu',
            'kecamatan_id',
