...
@section('page-name')
    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="{{ route('administrator.index') }}">Data Pemilu</a></li>
@endsection
                                ...
                                <tbody>
                                    @foreach ($users as $user)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">{{ $user['nama'] }}</td>
                                            <td class="align-middle text-center">{{ $user['alamat'] }}</td>
                                            <td class="align-middle text-center">{{ $user['profil'] }}</td>
                                            <td class="align-middle text-center">{{ $user['periode'] }}</td>
                                            <td class="align-middle text-center">{{ $user['dapil'] }}</td>
                                            <td class="align-middle text-center">{{ $user['desa'] }}</td>
                                            <td class="align-middle text-center">{{ $user['kecamatan'] }}</td>
                                            <td class="align-middle text-center">{{ $user['kabupaten'] }}</td>
                                            <td class="align-middle text-center">{{ $user['provinsi'] }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
