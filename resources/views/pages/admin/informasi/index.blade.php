                ...
                <div class="card shadow border">
                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            ...
                            <p>
                                Website ini aktif dan berjalan hingga
                                <strong>{{ $project->expired_date ? \Carbon\Carbon::parse($project->expired_date)->isoFormat('D MMMM Y') : 'N/A' }}</strong>.
                                Pastikan data dan
                        ...
                        <div class="mb-4">
                            ...
                            <ul class="list-group mb-2">
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    Admin
                                    <span class="badge bg-success rounded-pill">{{ $admin->count() }} Akun</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    Pengguna (User)
                                    <span class="badge bg-primary rounded-pill">{{ $user->count() }} Akun</span>
                                </li>
                            </ul>
                            <small class="text-muted">Jika membutuhkan penambahan akun, silakan hubungi
                                <span class="fw-bolder text-decoration-underline">
                                    <a href="{{ route('request.create') }}">Pengelola sistem (Klik di sini)</a>
                                </span>
                            </small>
                        </div>
